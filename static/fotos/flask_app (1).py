...
def login():
    ...
    # Si el método es GET, simplemente muestra la página de login.
    return render_template('login.html')
...
def ver_mapa():
    ...
    for tienda in tiendas:
        # Corrección de lógica: usa la foto de la tienda actual
...
@app.route('/pedido')
@login_required # <-- Es mejor usar el decorador aquí
def pedido():
    return render_template('pedido.html')# app.py
